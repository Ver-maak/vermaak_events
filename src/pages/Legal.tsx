...
const content: Record<string, { title: string; body: string }> = {
  terms: {
    ...
    body: `Welcome to EventSuite, a product of Vermaak. By using the platform you agree to these terms.
...
3. Tickets and refunds. EventSuite facilitates ticket sales between organizers and attendees. Refund decisions are made by the organizer unless required otherwise by law.
...
6. Liability. To the maximum extent permitted by law, EventSuite (Vermaak) is not liable for indirect or consequential damages.

These terms are a placeholder template. Replace with your final legal copy before going to production.`,
  },
  privacy: {
    title: "Privacy Policy",
    body: `EventSuite, a product of Vermaak, collects only the data needed to operate the service.
